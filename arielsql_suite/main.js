...
// Fixed: Correct 2-token factory address 0x8e9aa87e45e92bad84d5f8dd5b9431736d4bfb3e
// Fixed: Correct ABI (individual token0/token1, weight0/weight1, no rateProviders)
// Fixed: Idempotent (catch revert on duplicate create)
// Fixed: SCW execute for joinPool (tokens in SCW)
// Fixed: Sorted tokens, INIT kind=0
...
const WEIGHTED_POOL2_FACTORY = ethers.getAddress("0x8e9aa87e45e92bad84d5f8dd5b9431736d4bfb3e"); // Correct 2-token WeightedPool2TokensFactory
